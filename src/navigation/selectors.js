...
export function selectPanelProps(state) {
  ...
  return {
    ...
    formsFillReturnToLead: !!formsFill?.returnToLead,
    formsEditReturnToLead: !!formsEdit?.returnToLead,
    formsFillLeadId: formsFill?.leadId ?? formsEdit?.leadId ?? null,
    formsEditReturnToFormPicker: !!formsEdit?.returnToFormPicker,
    ...
    isLeadContactActionOpen: !!(phoneOverlay || emailOverlay),
    ...
    createTaskOpen: state.modalStack.some((m) => m.type === 'createTask'),
