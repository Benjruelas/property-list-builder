...
const PROPERTY_LABELS = {
  ...
  OWNER_TYPE: 'Owner Type', PARCEL_TYPE: 'Parcel Type',
...
export const CATEGORIES = {
  ...
  ownership: { title: 'Ownership', keys: ['OWNER_NAME', 'OWNER', 'OWNERNME1', 'MAIL_OWNER', 'OWNER_TYPE', 'PARCEL_TYPE', 'HOMESTEAD_EXEMPTION'] },
