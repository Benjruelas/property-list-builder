...
export function SignUp({ isOpen, onClose, onSwitchToLogin }) {
  ...
  }, [currentUser, authLoading, isOpen, onClose])
  ...
  const handleSubmit = async (e) => {
    ...
    if (password !== confirmPassword) {
      // You might want to use showToast here
    ...
    <Dialog open={isOpen} onOpenChange={(open) => {
      ...
      <DialogContent className="map-panel auth-dialog max-w-md" showCloseButton={false}>
        <DialogHeader>
          ...
          <DialogDescription>
            Sign up to start building your property lists
          </DialogDescription>
        </DialogHeader>
        ...
        {iosStandalone ? (
          <div className="mt-4 space-y-2 text-center text-sm text-gray-600">
            <p>
              Google sign-up is not available in the Home Screen app. Create an account with email above, or open KnockScout in Safari.
            </p>
            <a
