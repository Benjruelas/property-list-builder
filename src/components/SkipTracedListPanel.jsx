                    ...
                    {skipTracedList.parcels.map((parcel, index) => {
                      ...
                      return (
                        <div
                          key={parcelId}
                          className={cn(
                            "flex items-center justify-between p-2 border rounded-lg bg-gray-50/50 cursor-pointer hover:bg-gray-100 transition-colors",
                            onOpenParcelDetails && "hover:border-gray-400"
                          )}
                          onClick={() => {
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    {skipTracedList.listItems.map((listItem) => {
                      ...
                      return (
                        <div key={listItem.listId} className="border rounded-lg bg-gray-50/50">
                          <div
                          ...
                          {isExpanded && (
                                <div className="px-3 pb-3 pt-1 space-y-1 border-t bg-white/50">
                                  {listItem.parcels.map((parcel, index) => {
                                    ...
                                    return (
                                      <div
                                        key={parcelId}
                                        className={cn(
                                          "flex items-center justify-between p-2 border rounded bg-white text-sm cursor-pointer hover:bg-gray-50 hover:border-gray-300 transition-colors",
                                          onOpenParcelDetails && "hover:bg-gray-50"
                                        )}
                                        onClick={() => {
                                          if (onOpenParcelDetails) {
                                            // Prepare parcel data in the format expected by ParcelDetails
