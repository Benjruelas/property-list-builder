...
const STEPS = [
  ...
  { target: '[data-tour="menu-email-templates"]', title: 'Email Templates',     desc: 'Create and manage reusable email templates for outreach', menuRequired: true },
  { target: '[data-tour="menu-text-templates"]',  title: 'Text Templates',      desc: 'Create and manage reusable text message templates', menuRequired: true },
  { target: '[data-tour="menu-pipeline"]',        title: 'Deal Pipeline',       desc: 'Track leads through your deal stages', menuRequired: true },
