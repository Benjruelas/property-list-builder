...
const DialogContent = React.forwardRef(({ className, children, showCloseButton = true, hideOverlay = false, ...props }, ref) => (
  <DialogPortal container={typeof document !== 'undefined' ? document.getElementById('modal-root') || document.body : undefined}>
    {hideOverlay ? (
      <DialogPrimitive.Overlay className="fixed inset-0 z-[9998] bg-transparent pointer-events-none" />
    ) : (
      <DialogOverlay />
    )}
