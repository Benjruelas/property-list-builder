...
export const ToastContainer = () => {
  ...
  const content = (
    <div className="fixed left-1/2 -translate-x-1/2 z-[99999] flex flex-col gap-2 items-center pointer-events-none [&>*]:pointer-events-auto" style={{ top: 'calc(env(safe-area-inset-top, 0px) + 3rem)' }}>
      {toasts.map(toast => (
        <div
          key={toast.id}
          className={cn(
