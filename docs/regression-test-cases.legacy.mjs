...
export const LEGACY_TEST_CASES = [
  ...
  tc('NAV-024', '03', 'Quick Create opens direct new-item panels', ADM, 'both', 'Logged in; repeat while each matching list panel is open', ['Choose Task from Quick Create (+)', 'Choose Lead from Quick Create (+)', 'Choose Deal from Quick Create (+)', 'Choose Quote from Quick Create (+)', 'Choose Report from Quick Create (+)', 'Repeat each action while its matching list panel is open, then press Back'], 'Every action opens its canonical new-item panel immediately; no parent-list detour or prerequisite picker overlay; Back restores the prior surface'),
