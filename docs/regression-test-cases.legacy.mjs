...
export const LEGACY_TEST_CASES = [
  ...
  tc('AUTH-007', '01', 'Gated action opens login when logged out', ['logged-out'], 'both', 'Logged out', ['Open Menu', 'Tap Leads'], 'Login modal opens instead of panel'),
  tc('AUTH-008', '01', 'Location/orientation permission prompt', IN, 'both', 'Fresh session or reset permissions', ['Clear the site location permission and reload the app', 'Choose Grant and confirm the map remains usable', 'Reset the permission, reload, and choose Deny'], 'Permission prompt appears; both Grant and Deny leave the app interactive with no blank screen or uncaught-error message'),
  tc('AUTH-009', '01', 'Notification permission prompt', IN, 'both', 'Logged in, notifications not granted', ['Clear the site notification permission and reload the app', 'Choose Allow or Block', 'Reload the app'], 'Notification prompt appears; the selected browser permission remains set after reload'),
  ...
  tc('MAP-011', '02', 'Close parcel popup', IN, 'both', 'Popup open', ['Tap the popup close button'], 'Popup dismisses'),
  ...
  tc('MAP-019', '02', 'Edit contacts in details', IN, 'both', 'Details open', ['Add a test phone number', 'Mark the phone number primary and verified', 'Save the contact changes', 'Close and reopen Parcel Details'], 'Saved phone number is shown with primary and verified indicators after reopening'),
  ...
  tc('LST-020', '04', 'Parcel list — remove parcel from list', ADM, 'both', 'Own list', ['Expand a parcel row', 'Open the parcel row actions and click Remove from list', 'Confirm removal'], 'Parcel removed from list'),
  ...
  tc('LED-010', '05', 'Lead phone/text/email actions', IN, 'both', 'Lead with phone and email contact info', ['Tap the phone number', 'Inspect PhoneActionPanel for Text and Call actions', 'Close PhoneActionPanel', 'Tap the text action', 'Inspect the text composer for the selected phone number', 'Close the text composer', 'Tap the email address'], 'EmailComposer opens for the selected lead and the prior phone/text panels closed cleanly'),
  ...
  tc('LED-016', '05', 'Schedule at date from lead', IN, 'both', 'Lead detail open', ['Click View on schedule'], 'Schedule opens at date'),
  ...
  tc('DPL-010', '06', 'Deal detail — preview/delete file', ADM, 'both', 'File attached', ['Click the attached file to open its preview', 'Close the preview', 'Open the file actions and choose Delete', 'Confirm deletion'], 'The selected file renders in preview; the deleted file no longer appears in the files list'),
  ...
  tc('PUB-011', '12', 'Sync failure while offline shows feedback', IN, 'both', 'Logged in with unsaved change', ['Set devtools Network throttling to Offline', 'Open Menu → Settings', 'Click Sync now', 'Record the offline error while confirming the unsaved change remains visible', 'Restore the network connection', 'Click Sync now again'], 'Clear error feedback appears while offline; the unsaved change remains intact; the second sync succeeds once online'),
