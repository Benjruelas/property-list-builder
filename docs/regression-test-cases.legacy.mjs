...
export const LEGACY_TEST_CASES = [
  ...
  tc('PUB-011', '12', 'Sync failure while offline shows feedback', IN, 'both', 'Logged in with unsaved change', ['Set devtools Network throttling to Offline', 'Open Settings and click Sync now', 'Record the offline error while confirming the unsaved change remains visible', 'Restore the network connection', 'Click Sync now again'], 'Clear error feedback appears while offline; the unsaved change remains intact; the second sync succeeds once online'),
