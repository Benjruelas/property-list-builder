...
export const LEGACY_TEST_CASES = [
  ...
  tc('DPL-019', '06', 'Canonical Deal pipe', IN, 'both', 'Migrated account', ['Open Pipes → Deals', 'Verify stage header colors match Deal statuses', 'Collapse and expand a stage'], 'Exactly one deal pipe; configured colors appear and each stage collapses without changing its deals'),
  tc('DPL-020', '06', 'Lead pipe uses lead states', IN, 'both', 'Account with leads', ['Open Pipes → Leads', 'Verify stage header colors match Lead statuses', 'Collapse and expand a stage', 'Drag lead to another column'], 'Configured colors appear, each stage collapses, and lead state persists after refresh'),
