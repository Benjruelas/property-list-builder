...
export const LEGACY_TEST_CASES = [
  ...
  tc('DPL-019', '06', 'Canonical Deal pipe', IN, 'both', 'Migrated account', ['Open Pipes → Deals', 'Inspect header controls'], 'Exactly one deal pipe; no create, switch, share, delete, or column-edit controls'),
  tc('DPL-020', '06', 'Lead pipe uses lead states', IN, 'both', 'Account with leads', ['Open Pipes → Leads', 'Drag lead to another column'], 'Lead state persists after refresh'),
