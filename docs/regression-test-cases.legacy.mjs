...
export const LEGACY_TEST_CASES = [
  ...
  tc('AUTH-008', '01', 'Location/orientation permission prompt', IN, 'both', 'Fresh install/site data; test persistent, temporary, denied, and revoked access on native and PWA targets', ['Load with fresh site data and tap Continue', 'Relaunch after a persistent grant', 'Relaunch after temporary access expires, denial, or revocation', 'Deny orientation and continue startup'], 'Onboarding is one-time; permission is checked without an automatic prompt; denied or expired access has explicit recovery'),
  ...
  tc('MAP-004', '02', 'Recenter to user location', IN, 'both', 'Test with location granted, prompt, and denied', ['With access granted, tap recenter/locate', 'With permission in prompt state, tap the location control', 'With permission denied or revoked, tap the location control'], 'Granted access recenters; unavailable access has non-blocking explicit recovery'),
  ...
  tc('NAV-024', '03', 'Quick Create opens direct new-item panels', ADM, 'both', 'Logged in; repeat while each matching list panel is open', ['Choose Task from Quick Create (+)', 'Choose Lead from Quick Create (+)', 'Choose Deal from Quick Create (+)', 'Choose Quote from Quick Create (+)', 'Choose Report from Quick Create (+)', 'Repeat each action while its matching list panel is open, then press Back', 'From Tasks/Leads/Deals/Quotes/Reports headers, tap + and confirm the create panel is visible above any scrim'], 'Every FAB and list + action opens its canonical new-item panel immediately above a correctly layered scrim; no parent-list detour, template/lead picker detour, or scrim covering the panel'),
  ...
  tc('DPL-013', '06', 'Deal detail — change state', IN, 'both', 'Deal detail open', ['Change deal state'], 'Deal moves to the matching Deal pipe column'),
  ...
  tc('DPL-017', '06', 'Open Deal pipe', IN, 'both', 'Migrated account', ['Action bar → Pipes', 'Select Deals tab'], 'Settings-derived columns and deal cards visible'),
  tc('DPL-018', '06', 'Open Lead pipe', IN, 'both', 'Account with leads', ['Action bar → Pipes', 'Select Leads tab'], 'Settings-derived columns and lead cards visible'),
  tc('DPL-019', '06', 'Canonical Deal pipe', IN, 'both', 'Migrated account', ['Open Pipes → Deals', 'Compare panel header and tabs with Reports', 'Verify no Tasks section is present', 'Verify full stage containers match Deal status colors', 'Confirm individual deal cards are visually distinct', 'Collapse and expand a stage'], 'Pipes uses the standard panel shell without a Tasks section; configured colors cover each stage; individual cards remain distinct; stages collapse without changing deals'),
  tc('DPL-020', '06', 'Lead pipe uses lead states', IN, 'both', 'Account with leads', ['Open Pipes → Leads', 'Verify full stage containers match Lead status colors', 'Confirm individual lead cards are visually distinct', 'Collapse and expand a stage', 'Drag lead to another column'], 'Configured colors cover each stage, individual cards remain distinct, stages collapse, and lead state persists after refresh'),
  tc('DPL-021', '06', 'Rename deal state in Settings', ADM, 'both', 'Settings → Team → Deal statuses', ['Rename state and save', 'Open Deal Pipe'], 'Column uses the new state label'),
  tc('DPL-022', '06', 'State editing permissions', ['team-member'], 'both', 'Signed in as a non-admin team member', ['Open Lead and Deal statuses', 'Open both pipes'], 'State registries are read-only and pipes have no edit controls'),
