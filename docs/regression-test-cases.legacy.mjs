...
export const LEGACY_TEST_CASES = [
  ...
  tc('DPL-017', '06', 'Open Deal pipe', IN, 'both', 'Migrated account', ['Action bar → Deal Pipe'], 'Settings-derived columns and deal cards visible'),
  tc('DPL-018', '06', 'Open Lead pipe', IN, 'both', 'Account with leads', ['Action bar → Lead Pipe'], 'Settings-derived columns and lead cards visible'),
  tc('DPL-019', '06', 'Canonical Deal pipe', IN, 'both', 'Migrated account', ['Open Deal Pipe', 'Inspect header controls'], 'Exactly one pipe; no create, switch, share, delete, or column-edit controls'),
  tc('DPL-020', '06', 'Lead pipe uses lead states', IN, 'both', 'Account with leads', ['Open Lead Pipe', 'Drag lead to another column'], 'Lead state persists after refresh'),
