...
export const LEGACY_TEST_CASES = [
  ...
  tc('DPL-019', '06', 'Canonical Deal pipe', IN, 'both', 'Migrated account', ['Open Pipes → Deals', 'Compare panel header and tabs with Reports', 'Verify full stage containers match Deal status colors', 'Confirm individual deal cards are visually distinct', 'Collapse and expand a stage'], 'Pipes uses the standard panel shell; configured colors cover each stage; individual cards remain distinct; stages collapse without changing deals'),
